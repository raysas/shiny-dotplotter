...
# mandatory 
FASTA_1 = 'utils/example/protein_seq1.fasta'
FASTA_2 = 'utils/example/protein_seq2.fasta'
...
def workflow(w=WINDOW_SIZE, t=THRESHOLD, sm=SCORE_MATRIX, st=SEQ_TYPE, fasta1=FASTA_1, fasta2=FASTA_2):
    '''workflow to be called from main, returns fig object'''
    # -- get parameters from user..

    # -- validation --
    window, thresh, scor_mat, seqtype, sub_mat, seq1, seq2 = validation(w, t, sm, st, fasta1, fasta2)
